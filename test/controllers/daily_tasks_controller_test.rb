...
class DailyTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create daily_task" do
    assert_difference("DailyTask.count") do
      post daily_tasks_url, params: { daily_task: { daily_challenge_id: @daily_task.daily_challenge_id, task_id: @daily_task.task_id, total_score: @daily_task.total_score } }
    end
  ...
  test "should update daily_task" do
    patch daily_task_url(@daily_task), params: { daily_task: { daily_challenge_id: @daily_task.daily_challenge_id, task_id: @daily_task.task_id, total_score: @daily_task.total_score } }
